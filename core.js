...
(function (root, factory) {
  ...
  const VERIFIED_CLAIMS = [
    ...
    { id: "doctor-verdict-glue", claim: "the QA-REFUSAL seam can name an external lens honestly — tools/doctor-verdict.js digests a real SuperInstance/quilt-doctor checkout (HOLISTIC-VIEW + holistic-stats, shape-checked: every lens enumerated 8!=40320 perms) into a THREE-THINGS verdict line for refusal receipts; the seam ships closed (no checkout -> null -> nothing rendered, never faked) and any tamper reads as absent (Round 24)", proofTest: "tests/doctor-verdict-glue.test.js" },
